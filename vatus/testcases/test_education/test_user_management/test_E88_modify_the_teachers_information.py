...
class ModifyTeacherInfo(unittest.TestCase):
    def setUp(self):
        self.driver = None
        self.base_url = settings.test_parameters.get("education_base_url")

    def test_E88_modify_the_teachers_information(self):
        ...
        for web_type in web_types:
            ...
            driver.find_element_by_id("username").send_keys("teachert01")
            driver.find_element_by_id("fullname").clear()
            driver.find_element_by_id("fullname").send_keys("teachert01")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("teachert01@vinzor.com")
            ...
            driver.find_element_by_css_selector("input.form-control.input-sm").send_keys("teachert01")
            time.sleep(5)
            if web_type == 'firefox':
            ...
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("teacher@example.com")
            driver.find_element_by_id("confirm_action").click()
            time.sleep(1)
            ...
            driver.find_element_by_id("confirm_action").click()
            time.sleep(3)
            self.assertEqual("用户 teachert01 信息修改成功", driver.find_element_by_class_name("gritter-without-image").
