...
class ResetStudentPassword(unittest.TestCase):
    def setUp(self):
        self.driver = None
        self.base_url = settings.test_parameters.get("education_base_url")

    def test_E82_reset_student_password(self):
        ...
        for web_type in web_types:
            ...
            time.sleep(2)
            driver.find_element_by_id("input_username").clear()
            driver.find_element_by_id("input_username").send_keys("student")
            driver.find_element_by_id("input_password").clear()
