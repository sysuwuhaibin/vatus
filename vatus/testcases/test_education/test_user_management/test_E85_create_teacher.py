...
class CreateTeacher(unittest.TestCase):
    def setUp(self):
        self.driver = None
        self.base_url = settings.test_parameters.get("education_base_url")

    def test_E85_create_teacher(self):
        ...
        for web_type in web_types:
            ...
            ###########################################
            driver.find_element_by_id("username").clear()
            driver.find_element_by_id("username").send_keys("createteacher")
            driver.find_element_by_id("fullname").clear()
            driver.find_element_by_id("fullname").send_keys("createteacher")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("createteacher@vinzor.com")
            driver.find_element_by_id("password").clear()
            ...
            driver.find_element_by_id("confirm_action").click()
            time.sleep(5)
            self.assertEqual("用户 createteacher 创建成功", driver.find_element_by_class_name("gritter-without-image").
            ...
            driver.find_element_by_id("fullname").send_keys("createteacher")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("teacher02@vinzor.com")
            driver.find_element_by_id("password").clear()
            driver.find_element_by_id("password").send_keys("123456")
            driver.find_element_by_id("confirm").clear()
            driver.find_element_by_id("confirm").send_keys("123456")
            ...
            time.sleep(1)
            driver.find_element_by_id("username").clear()
            driver.find_element_by_id("username").send_keys("teacher02")
            driver.find_element_by_id("fullname").clear()
            driver.find_element_by_id("fullname").send_keys("teacher02")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("createteacher@vinzor.com")
            driver.find_element_by_id("password").clear()
            driver.find_element_by_id("password").send_keys("123456")
            ...
            time.sleep(2)
            driver.find_element_by_id("input_username").clear()
            driver.find_element_by_id("input_username").send_keys("createteacher")
            driver.find_element_by_id("input_password").clear()
            ...
            driver.find_element_by_css_selector("input.form-control.input-sm").send_keys("createteacher")
            time.sleep(5)
            if web_type == 'firefox':
