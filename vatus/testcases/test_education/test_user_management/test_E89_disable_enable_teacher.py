...
class DisableEnableTeacher(unittest.TestCase):
    def setUp(self):
        self.driver = None
        self.base_url = settings.test_parameters.get("education_base_url")

    def test_E89_disable_enable_teacher(self):
        ...
        for web_type in web_types:
            ...
            driver.find_element_by_id("username").send_keys("teacher01")
            driver.find_element_by_id("fullname").clear()
            driver.find_element_by_id("fullname").send_keys("teacher01")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("teacher01@vinzor.com")
            ...
            time.sleep(5)
            self.assertEqual("用户 teacher01 创建成功", driver.find_element_by_class_name("gritter-without-image").
            ...
            driver.find_element_by_css_selector("input.form-control.input-sm").send_keys("teacher01")
            time.sleep(5)
            if web_type == 'firefox':
            ...
            time.sleep(5)
            self.assertEqual("用户 teacher01 禁用成功", driver.find_element_by_class_name("gritter-without-image").
                             find_element_by_tag_name("p").text)
            time.sleep(8)
            ...
            time.sleep(2)
            driver.find_element_by_id("input_username").clear()
            driver.find_element_by_id("input_username").send_keys("teacher01")
            driver.find_element_by_id("input_password").clear()
            ...
            if web_type == 'firefox':
                ...
                webdriver.ActionChains(driver).move_to_element(element).click().perform()
            time.sleep(3)
            self.assertEqual("用户 teacher01 激活成功", driver.find_element_by_class_name("gritter-without-image").
                             find_element_by_tag_name("p").text)
            time.sleep(8)
            driver.find_element_by_css_selector("span.user-info").click()
            time.sleep(1)
