...
class CreateStudent(unittest.TestCase):
    ...
    def test_E79_create_student(self):
        ...
        for web_type in web_types:
            ...
            driver.find_element_by_id("confirm_action").click()
            time.sleep(5)
            self.assertEqual("用户 student01 创建成功", driver.find_element_by_class_name("gritter-without-image").
            ...
            driver.find_element_by_id("fullname").send_keys("student01")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("student02@vinzor.com")
            driver.find_element_by_id("password").clear()
            driver.find_element_by_id("password").send_keys("123456")
            driver.find_element_by_id("confirm").clear()
            driver.find_element_by_id("confirm").send_keys("123456")
            ...
            time.sleep(1)
            driver.find_element_by_id("username").clear()
            driver.find_element_by_id("username").send_keys("student02")
            driver.find_element_by_id("fullname").clear()
            driver.find_element_by_id("fullname").send_keys("student02")
            driver.find_element_by_id("email").clear()
            driver.find_element_by_id("email").send_keys("student01@vinzor.com")
            driver.find_element_by_id("password").clear()
            driver.find_element_by_id("password").send_keys("123456")
            ...
            time.sleep(2)
            driver.find_element_by_id("input_username").clear()
            driver.find_element_by_id("input_username").send_keys("student01")
            driver.find_element_by_id("input_password").clear()
